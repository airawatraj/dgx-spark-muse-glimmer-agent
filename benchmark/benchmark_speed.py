...
# ///
"""
DGX Spark / Muse-Glimmer-30B-NVFP4-W4A4 Benchmark
Tests TPS, TTFT, and maximum usable context window against the local vLLM endpoint.

Usage:
  uv run benchmark/benchmark_speed.py
  uv run benchmark/benchmark_speed.py --model Cogni-Brain
...
def test_tps_vs_length(host, port, model):
    ...
    for max_tok in lengths:
        ...
        if err:
            ...
            print(f"  {str(str(tokens)+' tok').ljust(18)} "
...
def main():
    parser = argparse.ArgumentParser(
        description="Benchmark DGX Spark · Muse-Glimmer-30B-NVFP4-W4A4 vLLM setup",
    ...
    print(f"\n{c('DGX Spark · Muse-Glimmer-30B-NVFP4-W4A4 Benchmark', 'bold')}")
